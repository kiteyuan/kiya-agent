  ...
  return (
    <div className="relative flex h-full min-h-0 flex-col">
            ...
            >
              ...
              <div className="flex shrink-0 items-center gap-4">
                <button
                  ...
                  aria-label={t("playlist.play", { name: item.title })}
                >
                ...
                <button
                  ...
                  aria-label={t("playlist.delete", { name: item.title })}
                >
      ...
      <button
        ...
        aria-label={t("playlist.clearHistory")}
      >
        <Trash2 className="h-4 w-4" />
      </button>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/20 px-4 backdrop-blur-sm dark:bg-black/40">
          <div className="w-full max-w-sm rounded-3xl bg-white p-5 text-zinc-950 shadow-[0_12px_40px_rgba(0,0,0,0.12)] dark:bg-zinc-900 dark:text-zinc-100">
            <div className="space-y-2">
              <p className="text-sm font-medium">{t("playlist.clearHistoryTitle")}</p>
              <p className="text-xs text-zinc-400 dark:text-zinc-500">
                {t("playlist.clearHistoryDescription")}
              </p>
            </div>
            <div className="mt-5 flex justify-end gap-2">
              ...
              >
                {isClearingHistory ? t("playlist.clearing") : t("app.confirmDelete")}
              </button>
            </div>
          </div>
        </div>
